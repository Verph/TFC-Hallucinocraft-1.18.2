...
{
    AGAVE(NutrientType.NITROGEN, 6, null),
    ...
    FLAX(NutrientType.POTASSIUM, 7, null),
    HEMP(NutrientType.POTASSIUM, 2, 3, false, ModItems.CANNABIS_BUD),
    HOP(NutrientType.NITROGEN, 2, 4, false, ModItems.HOP),
    INDIGO(NutrientType.PHOSPHOROUS, 6, null),
    MADDER(NutrientType.NITROGEN, 5, null),
    PEYOTE(NutrientType.POTASSIUM, 4, null),
    TOBACCO(NutrientType.NITROGEN, 3, 4, false, ModItems.TOBACCO_BUD),
    WELD(NutrientType.POTASSIUM, 5, null),
    WOAD(NutrientType.PHOSPHOROUS, 5, null);
