...
public class DrugEffects {
    ...
    public final FloatDrugEffect SOUL_RESTER_AMBIENCE = registerClient();
    public final FloatDrugEffect SOUL_WRENCHER_AMBIENCE = registerClient();
    public final FloatDrugEffect RED_SHROOM_AMBIENCE = registerClient();
    public final FloatDrugEffect BROWN_SHROOM_AMBIENCE = registerClient();
    public final FloatDrugEffect PEYOTE_AMBIENCE = registerClient();
    public final FloatDrugEffect CANNABIS_AMBIENCE = registerClient();
    public final FloatDrugEffect COCAINE_AMBIENCE = registerClient();
    public final FloatDrugEffect TOBACCO_AMBIENCE = registerClient();
    public final FloatDrugEffect MORPHINE_AMBIENCE = registerClient();
    public final FloatDrugEffect OPIUM_AMBIENCE = registerClient();
    public final FloatDrugEffect CAFFEINE_AMBIENCE = registerClient();
    public final FloatDrugEffect GLITCH_AMBIENCE = registerClient();
    public final FloatDrugEffect LSD_AMBIENCE = registerClient();
    public final FloatDrugEffect DMT_AMBIENCE = registerClient();
    public final FloatDrugEffect NICOTINE_AMBIENCE = registerClient();
