...
public class HallucinocraftConfig
{
    ...
    {
        public final ForgeConfigSpec.IntValue additionalCropDrops;
        
        Common(ForgeConfigSpec.Builder builder)
        {
            additionalCropDrops = builder.comment("Max additional crop produce that can be dropped when harvesting by right-clicking.").defineInRange("additionalCropDrops", 4, 0, Integer.MAX_VALUE);
        }
    }
